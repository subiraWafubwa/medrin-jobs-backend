"""changed JobRequirement.description to JobRequirement.requirements

Revision ID: 69e7379c5b72
Revises: 25c7fe91eba8
Create Date: 2024-11-10 10:46:18.392040
...
revision = '69e7379c5b72'
down_revision = '25c7fe91eba8'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('shortlisted_applications', schema=None) as batch_op:
        batch_op.alter_column('job_id',
               existing_type=sa.NUMERIC(),
               type_=sa.UUID(),
               existing_nullable=False)
